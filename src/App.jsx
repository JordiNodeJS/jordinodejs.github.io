...
function App() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white/10 to-transparent dark:from-neutral-900/90 dark:to-neutral-900/50 text-black dark:text-white transition-colors backdrop-blur-[1px]">
