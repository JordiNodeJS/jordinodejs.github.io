...
const Skills = () => {
  // Datos temporales de skills hasta migrar completamente al sistema centralizado
  const skillsDataFromHook = [
    { id: 'javascript', name: 'JavaScript', level: 90 },
    { id: 'typescript', name: 'TypeScript', level: 85 },
    { id: 'react', name: 'React', level: 88 },
    { id: 'nodejs', name: 'Node.js', level: 75 },
    { id: 'tailwind', name: 'TailwindCSS', level: 80 },
    { id: 'astro', name: 'Astro', level: 70 },
  ...
  const techStack = [
    ...
    { icon: SiAstro, name: 'Astro', color: 'from-orange-500 to-purple-600' },
      ...
      <div className="container-custom">
              ...
              {techStack.map((tech, index) => (
                ...
                >
                  <Skill3DCard
                    ...
                    color={tech.color}
                    description={getDescriptionForTech(
                      tech.name,
                      skillsTranslations.techStackDescriptions
                    )}
                  />
                </motion.div>
              ))}
        ...
        >
            ...
            {[
              {
                ...
                description:
                  skillsTranslations.methodologyDescriptions.agileScrum
              },
              {
                name: 'Git/GitHub',
                color: 'bg-cyan-400',
                ...
                description:
                  skillsTranslations.methodologyDescriptions.gitGithub
              },
              {
                name: 'Testing',
                color: 'bg-pink-400',
                icon: <SiTestinglibrary className="w-8 h-8 text-black" />,
                description: skillsTranslations.methodologyDescriptions.testing
              },
              {
                name: 'CI/CD',
                color: 'bg-green-400',
                icon: <SiJenkins className="w-8 h-8 text-black" />,
                description: skillsTranslations.methodologyDescriptions.cicd
              }
            ].map((method, index) => (
              <motion.div
                key={method.name}
          ...
          >
            ...
            >
              {theme === 'brutalism'
                ? skillsTranslations.efficientMethodologiesBrutalism
                : skillsTranslations.efficientMethodologies}
            </p>
          </div>
        </motion.div>
      </div>
