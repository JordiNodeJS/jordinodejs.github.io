...
const Education = () => {
  ...
  const { education: educationDataFromCentralized } = useCentralizedPortfolioData();

  // Use education data from centralized system
  const education = educationDataFromCentralized || [];
