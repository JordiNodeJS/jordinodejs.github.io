          ...
          <h3 className="font-medium flex flex-col gap-1 text-orange-200">
            <div>
              <a
                ...
                href={project.deploy}
                target="_blank"
                aria-label={project.title} rel="noreferrer"
              >
          ...
          <div className="relative pt-2 ">
            {project.repository && (
              <a
                ...
                target="_blank"
                className="inline-flex items-center font-semibold text-sm baseline  leading-tight dark:text-orange-200 text-orange-950 hover:dark:text-orange-100/60 hover:text-orange-800 focus-visible:text-orange-300 " rel="noreferrer"
              >
                <div className="w-8">
                  <GithubIcon />
                </div>
