...
export const usePortfolioTranslations = () => {
  ...
  const navigation = {
    ...
    scrollToTop: t('navigation.scrollToTop')
  }
  ...
  const skills = {
    ...
    efficientMethodologies: t('skills.efficientMethodologies'),
    efficientMethodologiesBrutalism: t(
      'skills.efficientMethodologiesBrutalism'
    ),
    methodologyDescriptions: {
      agileScrum: t('skills.methodologyDescriptions.agileScrum'),
      gitGithub: t('skills.methodologyDescriptions.gitGithub'),
      testing: t('skills.methodologyDescriptions.testing'),
      cicd: t('skills.methodologyDescriptions.cicd')
    },
    categories: {
  ...
  // Helper para footer
  const footer = {
    portfolioName: t('footer.portfolioName'),
