...
export const useBrutalismEffects = () => {
  ...
  useEffect(() => {
    if (theme === 'brutalism') {
      ...
      // Crear partículas cada 8 segundos (reducido de 2 segundos)
      const particleInterval = setInterval(createBrutalParticle, 8000)
      ...
      return () => {
        ...
        const particles = document.querySelectorAll('div[style*="brutalFloat"]')
